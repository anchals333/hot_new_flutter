...
import 'package:hot_new/home/newtab/new_tab_bloc.dart';
import 'package:hot_new/home/newtab/newtab_model.dart';
import 'package:lottie/lottie.dart';


class NewTabRoute extends StatefulWidget {
  @override
  State<StatefulWidget> createState() {
    return _NewTabRouteState();
  }
}

class _NewTabRouteState extends State<NewTabRoute> {
  ...
  final topAppBar = AppBar(
    ...
    title: Text("B", style: TextStyle(color: Color(0xFFda393a))),
  );
  ...
  Widget _buildServicesHistoryRoute(List<NewModel> data) {
    return Expanded(
  ...
  Widget _buildListview(NewModel data) {
    return Card(
      elevation: 8.0,
